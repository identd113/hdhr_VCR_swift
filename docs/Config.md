...
Web_server_enabled      Bool    false   enable NWListener LAN web server (Settings → Web LAN)
...
Virtual_tuner_relay_enabled Bool false  Recording FEED — advertise a temporary tuner while recording so another instance can watch it live (Settings → Web LAN, see docs/VirtualTunerService.md)
