...
- **Transcode** — `Picker`: None / Heavy / Mobile / Internet 720. When the selected profile isn't None and the device doesn't support transcoding (`HDHRDevice.supportsTranscode`), an orange warning banner appears below it saying the setting will be ignored and recorded as None — see `docs/ShowFormSection.md`.
