...
```
[Channel picker ─────────] Spacer [buffer|⏭ pill] [☑ H.264] [1:1] [🕐] [🔊] [─── slider ───] | [🎧 audio track] | [CC picker] | [♩ audio device] | [📺 screen menu]
```
